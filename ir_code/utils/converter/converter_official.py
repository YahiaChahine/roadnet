...
def main(args):
    if args.cityflownet is None:
        args.cityflownet = args.sumonet.replace('.net.xml', '.json')
...
def parse_args():
    ...
    parser.add_argument("--sumonet", type=str, default='./RL_basis_8_phase.net.xml')
    parser.add_argument("--cityflownet", type=str, default='./RL_basis_8_phase.net.json')
